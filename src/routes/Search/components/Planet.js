        ...
        <div className="wrapper">
            <div className="myclimate">
                <div className="myclimate-content">
                    <h2><span className="focus-text"><span className="underline"></span>THINKING ABOUT</span><br/><span className="focus-text"><span className="underline"></span>THE PLANET !</span><br/><span className="focus-text"><span className="underline"></span>( SOON )</span></h2>
                    <br/>
