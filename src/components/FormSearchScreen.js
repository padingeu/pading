         ...
         {this.props.displayFromWhereScreen ?
          <div className="search-screen">
            <div className="searchbar">
              <button
                className="btn-back"
                onClick={this.props.isHomePage ? (event) => {this.props.goToHomePage(event)} : (event) => {this.props.goToResultsPage(event)}}
              >
            ...
            <div className="search-criteria-confirm">
              ...
              >
                {this.props.citiesFrom.length < 2 ? 'Select at least 2 departure cities' : 'Select these cities'}
              </button>
            </div>
          </div>
        :''}
          ...
          <div className="search-screen">
            ...
            <div className="search-criteria-confirm">
              <button
                ...
                onClick={(event) => {this.props.goToDetailsPage(event)}}
              >
                Continue
              </button>
            </div>
            ...
            <div className="searchbar">
              ...
              <div className="criteria">
                <div className="criteria-buttons">
                  <button
                    onClick={(event) => {this.props.switchToDirect(event)}}
                    className={this.props.directTrip ? 'criteria-btn criteria-btn-active' : 'criteria-btn'}
                  >
                    Only direct
                  </button>
                  <button
